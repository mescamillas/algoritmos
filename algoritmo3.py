...
def make_pipeline():
    ...
    value = (Fundamentals.ebit.latest + Fundamentals.enterprise_value.latest)/2
    ...
    funds = Fundamentals.market_cap.latest
    ...
    sentiment_score_winsorized = sentiment_score.winsorize(min_percentile=0,                                                                             max_percentile=1)
    funds_winsorized = funds.winsorize(min_percentile=0,                                                                                                            max_percentile=1)
